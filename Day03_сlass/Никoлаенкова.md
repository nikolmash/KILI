...
# 1.3 Почему количество документов меньше количества вхождений? Ответ:в некоторых документах встречается больше одного вхождения слова "подыми" 
```
...
```
# 3.4 Ответ: в поле "Слово" лексико-грамматического поиска вводится лексема, а строка "баба с возу" содержит сразу несколько слов
```
...
```
__Текст___: вс 3 167 354  
__статус__: префикс 38 773   
```
